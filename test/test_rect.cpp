...
TEST(Rectangle, ConstructionAndAccessors) {
    constexpr const auto a = IntRect { 0, 0, 16, 16 };
    constexpr const auto b = IntRect {
        IntPosition { 0, 0 },
        IntSize { 16, 16 },
    };
...
TEST(Rectangle, Addition) {
    constexpr const auto a = IntRect { 10, 10, 20, 20 };
    constexpr const auto b = a + a;
...
TEST(Rectangle, Subtraction) {
    constexpr const auto a = IntRect { 32, 32, 64, 64 };
    constexpr const auto b = IntRect { 16, 16, 32, 32 };
...
TEST(Rectangle, Multiplication) {
    constexpr const auto a = IntRect { 16, 16, 16, 16 };
...
TEST(Rectangle, ToSize) {
    constexpr const auto rect = IntRect { 0, 0, 32, 64 };
    constexpr const auto size = rect.to_size();
...
TEST(Rectangle, Equality) {
    constexpr const auto a = IntRect { 0, 0, 0, 0 };
    constexpr const auto b = IntRect { 16, 16, 16, 16 };
